...
var galaxyName = ['Achisa', 'Adio', 'Abun', 'Actun VI', 'Basari I', 'Bustun', 'Collibert Prime',
  'Flettiria', 'Gorogohl', 'Gorg', 'Hakogan', 'HIX I', 'Ichiamea', 'Idaka', 'Imcies', 
  'Iyan', 'Kaekai','Konangko', 'Kradak', 'Kushima', 'Loykio', 'LTD 368', 'Mocher',
  'Nadrask', 'Notogertasi', 'Noyader IX', 'Omister', 'Orisa 27', 'Phileek', 'Quaon-Iyl',
  'Quiidar II', 'Sayall', 'Shyinx', 'Soleth Prime', 'Spekira II', 'Sugas-Umoi',
  'Teogicia', 'Turka', 'Toniberli', 'Usnursven II', 'Vesta Prime', 'Vikfix II', 'Virgus VI', 
  'Xeria - p', 'Yesri','Zala', 'New Alon', 'New Diggister', 'New Errady', 'New Ventu'
];
